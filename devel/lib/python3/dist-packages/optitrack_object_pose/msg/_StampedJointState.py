...
"""autogenerated by genpy from optitrack_object_pose/StampedJointState.msg. Do not edit."""
import codecs
import sys
...
class StampedJointState(genpy.Message):
  _md5sum = "527fc01812df485c424aa8c714601eb6"
  _type = "optitrack_object_pose/StampedJointState"
...
float64[] effort
"""
  __slots__ = ['header','joint_state','isTracking']
  _slot_types = ['std_msgs/Header','sensor_msgs/JointState','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StampedJointState, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.joint_state is None:
        self.joint_state = sensor_msgs.msg.JointState()
      if self.isTracking is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.isTracking,) = _get_struct_B().unpack(str[start:end])
      self.isTracking = bool(self.isTracking)
      return self
