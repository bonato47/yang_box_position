#!/bin/bash
IMAGE_NAME="epfl-lasa/yang_optitrack"
...
if [ "${MODE}" != "connect" ]; then
    ...
    docker volume rm yang_project
    docker volume create --driver local \
    --opt type="none" \
    --opt device="${PWD}/../src/yang_project" \
    --opt o="bind" \
    "yang_project"

    FWD_ARGS+=(--volume="yang_project:/home/ros/ros_ws/src/yang_project:rw")
